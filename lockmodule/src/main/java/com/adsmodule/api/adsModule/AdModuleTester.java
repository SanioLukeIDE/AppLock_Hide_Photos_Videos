...
public class AdModuleTester {
    ...
    public static void showNativeAd(Activity activity, String nativeAd, LinearLayout adContainer, String adType, Drawable imageID) {
        cd = new ConnectionDetector(activity);
        if (imageID != null) {
    ...
    private static void populateUnifiedNativeAdView(Activity activity, NativeAd unifiedNativeAd, NativeAdView unifiedNativeAdView, String adType) {
        if (CheckEqualIgnoreCase(adType, "full")) {
