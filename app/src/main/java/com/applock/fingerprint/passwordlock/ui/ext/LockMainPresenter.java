...
import static com.applock.fingerprint.passwordlock.utils.Const.LOCK_FAVITER_NUM;
            ...
            while (infoIterator.hasNext()) {
                ...
                try {
                    ...
                    if(strings.contains(info.getPackageName())){
                        info.setFavoriteApp(true);
                    }
                 /*   boolean isExists = MyApplication.getLockDao().isExists(info.getPackageName());
                    if (!isExists) MyApplication.getLockDao().insertData(info);*/
