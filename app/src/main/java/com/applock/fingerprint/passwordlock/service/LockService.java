...
import static com.applock.fingerprint.passwordlock.utils.Const.LOCK_APART_MILLISENCONS;
...
import com.applock.fingerprint.passwordlock.singletonClass.AppOpenAds;
...
//        startForeground(NOTIFICATION_ID, buildNotification());
    ...
    public class ServiceReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            boolean isLockOffScreen = preferences.getFBoolean(LOCK_AUTO_SCREEN);
            boolean isLockOffScreenTime = preferences.getFBoolean(LOCK_AUTO_SCREEN_TIME);
